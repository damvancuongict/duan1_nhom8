...
<!-- Mirrored from html.themewin.com/edurock-preview/edurock/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jul 2023 15:56:36 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="col-xl-8 offset-md-2">
                                <div class="loginarea__wraper">
                                    ...
                                    <form action="index2.php?act=dangky" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="login__form">
                                                    ...
                                                    <input class="common__login__input" type="text" name="username" placeholder="Username">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="login__form">
                                                    ...
                                                    <input class="common__login__input" type="text" name="email" placeholder="Your Email">
                                        ...
                                        <div class="login__button">
                                            <input class="default__button" type="submit" value="Sign up" name="dangky">
                                        </div>
                                    </form>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3">
                            <div class="copyright__logo">
                                <a href="https://html.themewin.com/"><img src="img/logo/logo_2.png" alt="logo"></a>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6">
