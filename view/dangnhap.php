            ...
            <div class="tab-content tab__content__wrapper" id="myTabContent" data-aos="fade-up">
                    ...
                    <div class="tab-pane fade active show" id="projects__one" role="tabpanel" aria-labelledby="projects__one">
                        ...
                        <div>
                            ...
                            ?>
                                    <form action="index2.php?act=dangnhap">
                                        <div class="login__form">
                                            <label class="form__label">Username or email</label>
                                            <input class="common__login__input" type="text" name="username" placeholder="Your username or email">
                                        ...
                                        <div class="login__button">
                                            <!-- <a class="default__button" href="index2.php?act=dangnhap">Log In</a> -->
                                            <input class="default__button" style="width:100%;height: 50px" type="submit" value="Login" name="dangnhap">
                                        </div>
                                    </form>
